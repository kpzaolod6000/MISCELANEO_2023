...
const Atm = forwardRef(({ hasCustomDisplay = false }, ref) => {
    ...
    // const handleShowMoney = () => setshowMoney(true);
    // const handleHiddenMoney = () => setshowMoney(false);
    ...
    return (
        ...
        {!hasCustomDisplay && (
            ...
            // <>
            // <button onClick={handleShowMoney}>Mostrar dinero</button>
            // <button onClick={handleHiddenMoney}>Ocultar dinero</button>
            // </>
        )}
        </div>
    );
